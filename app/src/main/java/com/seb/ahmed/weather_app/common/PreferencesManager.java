...
public class PreferencesManager {
    ...
    private static final String SELECTED_Unit = "unit";
    ...
    public void storeSelectedUnit(String Unit) {
        settings.edit().putString(SELECTED_Unit, Unit).apply();
    }
...
//        settings.edit().putString(FAVORITES, jsonFavorites).apply();
    ...
    public String getLastSelectedCity() {
        return settings.getString(SELECTED, "Cairo");
    }

    public String getLastSelectedUnit() {
        return settings.getString(SELECTED_Unit, "metric");
    }
